...
<qgis hasScaleBasedVisibilityFlag="0" minScale="1e+08" maxScale="0" styleCategories="AllStyleCategories" version="3.20.0-Odense">
  <flags>
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" type="paletted" opacity="1" alphaBand="-1" band="1">
      ...
      <colorPalette>
        <paletteEntry alpha="255" value="1" label="A" color="#38a800"/>
        <paletteEntry alpha="255" value="2" label="B" color="#b0e000"/>
        <paletteEntry alpha="255" value="3" label="C" color="#ffaa00"/>
        <paletteEntry alpha="255" value="4" label="D" color="#ff0000"/>
      </colorPalette>
    ...
    <huesaturation colorizeRed="255" colorizeStrength="100" grayscaleMode="0" colorizeOn="0" colorizeGreen="128" saturation="0" colorizeBlue="128"/>
